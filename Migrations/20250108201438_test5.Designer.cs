...
namespace ReserveSystem.Migrations
{
    ...
    [Migration("20250108201438_test5")]
    partial class test5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReserveSystem.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("ReserveSystem.Models.TypeOfSchedule", "TypeOfShedule")
                        .WithMany()
                        .HasForeignKey("TypeOfSheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Staff");

                    b.Navigation("TypeOfShedule");
                });
