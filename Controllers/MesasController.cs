...
namespace ReserveSystem.Controllers
{
    public class MesasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdMesa,NumeroLugares,Estado")] Mesa mesa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMesa,NumeroLugares,Estado")] Mesa mesa)
        {
            if (id != mesa.IdMesa)
            {
                return NotFound();
