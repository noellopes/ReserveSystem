...
namespace ReserveSystem.Controllers
{
    public class ClientsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientId,Client_Name,Client_Phone,Client_Adress,Client_Email,Client_Nif,Client_Login,Client_Status")] Client client)
        {
