...
namespace ReserveSystem.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomTypeId,HasView,Type,Capacity,RoomCapacity,AccessibilityRoom")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomTypeId,HasView,Type,Capacity,RoomCapacity,AccessibilityRoom")] RoomType roomType)
        {
